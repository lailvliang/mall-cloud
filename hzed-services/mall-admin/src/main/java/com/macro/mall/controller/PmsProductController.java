...
public class PmsProductController {
    ...
    public CommonResult create(@Valid @RequestBody PmsProductParam productParam, BindingResult bindingResult) throws Exception{
    ...
    public static CommonResult deaultBlockHandle(PmsProductQueryParam productQueryParam, Integer pageSize
                                                                         , Integer pageNum ,BlockException be){
        return CommonResult.failed();
    }
