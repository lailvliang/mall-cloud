...
@FeignClient(name = ServiceNameConstants.MALL_USER_SERVICE, fallbackFactory = UserServiceFallbackFactory.class, decode404 = true)
public interface MallUserService extends UserService{
    /**
